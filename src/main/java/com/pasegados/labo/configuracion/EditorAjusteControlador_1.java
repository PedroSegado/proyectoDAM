...
import com.pasegados.labo.modelos.Ajuste1;
 ...
 */
public class EditorAjusteControlador_1 {
    ...
    private Stage stage;
    private Ajuste1 ajusteDuplicado;
    private Ajuste1 ajusteOriginal;
    ...
    public void initialize() {
        ...
        SpinnerValueFactory<Integer> valorMenuAnalisis = new SpinnerValueFactory.IntegerSpinnerValueFactory(1,9,1);
        SpinnerValueFactory<Integer> valorMenuCalibracion = new SpinnerValueFactory.IntegerSpinnerValueFactory(1,9,1);
        
        spAnalisisPagina.setValueFactory(valorPaginaAnalisis);
        spAnalisisPagina.setValueFactory(valorMenuAnalisis);
        spCalibracionPagina.setValueFactory(valorPaginaCalibracion);
        spCalibracionPagina.setValueFactory(valorMenuCalibracion);
    }
     ...
     */
    public void setAjuste(Ajuste1 ajuste) {
        this.ajusteOriginal = ajuste;
        this.ajusteDuplicado = (Ajuste1) ajuste.clone();
